...
<body>
    <!--     <div class="modal fade in" id="single-gallery-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabelTwo" style="display: block; padding-right: 17px;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="myModalLabelTwo">Details of <span class="item-name">Roof Design</span></h4> <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="img-holder item-image">
                                <picture>
                                    <source type="image/webp" srcset="http://php7.commonsupport.com/apartvilla/wp-content/themes/apartvilla/img/gallery/1.jpg.webp">
                                    <img src="http://php7.commonsupport.com/apartvilla/wp-content/uploads/2015/12/slide22-480x331.jpg" alt="image">
                                </picture>
                            </div>
                        </div>
